...
*/
(function(a){a.fn.clippy=function(b){_opts={width:14,height:14,color:"#ffffff",clippy_path:"/static/clippy.swf",keep_text:false,transparent:false};b=a.extend(_opts,b);this.each(function(c,e){if(b.text&&b.text!=""){text=b.text}else{if(a(e).data("text")&&a(e).data("text")!=""){text=a(e).data("text")}else{text=a(e).text()}}text=encodeURIComponent(text);var f="";if(typeof a(this).attr("id")==="undefined"||a.trim(a(this).attr("id")==="")){var d=Math.round(Math.random()*1024).toString(16);f="clippy-"+d;a(this).attr("id",f)}else{f=a(this).attr("id")}if(b.keep_text){a(this).html("")}swfobject.embedSWF(b.clippy_path,f,b.width,b.height,"10",false,{text:text},{scale:"noscale"})})}})(jQuery);